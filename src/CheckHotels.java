...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"Hotel Classico Inn", "Hotel Superioro", "GW Bajaj Hotel", "VK Shah Hotel", "Maximo The Hotel", "SK Twins Hotel", "Sharma Enterprises", "Propero Delgo Hotel", "Joseph Heart Hotel", "Merry Queens Hotel"};
        try{
            for(int i=0; i<=9; i++){
